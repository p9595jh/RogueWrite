...
/* harmony import */ var _components_no_page_no_page_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./components/no-page/no-page.component */ "./src/app/components/no-page/no-page.component.ts");
...
/* harmony import */ var _components_tool_tool_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./components/tool/tool.component */ "./src/app/components/tool/tool.component.ts");
/* harmony import */ var _components_game_game_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./components/game/game.component */ "./src/app/components/game/game.component.ts");
/* harmony import */ var _components_sub_sub_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./components/sub/sub.component */ "./src/app/components/sub/sub.component.ts");
/* harmony import */ var _components_temp_temp_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./components/temp/temp.component */ "./src/app/components/temp/temp.component.ts");
/* harmony import */ var _components_corvee_corvee_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./components/corvee/corvee.component */ "./src/app/components/corvee/corvee.component.ts");
/* harmony import */ var _components_cwrite_cwrite_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./components/cwrite/cwrite.component */ "./src/app/components/cwrite/cwrite.component.ts");
/* harmony import */ var _components_play_play_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./components/play/play.component */ "./src/app/components/play/play.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    { path: 'admin', component: _components_admin_admin_component__WEBPACK_IMPORTED_MODULE_29__["AdminComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'game/:num', component: _components_game_game_component__WEBPACK_IMPORTED_MODULE_31__["GameComponent"] },
    { path: 'tool', component: _components_tool_tool_component__WEBPACK_IMPORTED_MODULE_30__["ToolComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"] /*, DeactivateGuard*/] },
    { path: 'sub', component: _components_sub_sub_component__WEBPACK_IMPORTED_MODULE_32__["SubComponent"] },
    { path: 'temp/:num', component: _components_temp_temp_component__WEBPACK_IMPORTED_MODULE_33__["TempComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'corvee/:num', component: _components_corvee_corvee_component__WEBPACK_IMPORTED_MODULE_34__["CorveeComponent"] },
    { path: 'cwrite', component: _components_cwrite_cwrite_component__WEBPACK_IMPORTED_MODULE_35__["CwriteComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_14__["AuthGuard"]] },
    { path: 'play/:num', component: _components_play_play_component__WEBPACK_IMPORTED_MODULE_36__["PlayComponent"] },
    { path: 'no-page', component: _components_no_page_no_page_component__WEBPACK_IMPORTED_MODULE_28__["NoPageComponent"] },
    { path: '**', component: _components_no_page_no_page_component__WEBPACK_IMPORTED_MODULE_28__["NoPageComponent"] }
];
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_no_page_no_page_component__WEBPACK_IMPORTED_MODULE_28__["NoPageComponent"],
                _components_admin_admin_component__WEBPACK_IMPORTED_MODULE_29__["AdminComponent"],
                _components_tool_tool_component__WEBPACK_IMPORTED_MODULE_30__["ToolComponent"],
                _components_game_game_component__WEBPACK_IMPORTED_MODULE_31__["GameComponent"],
                _components_sub_sub_component__WEBPACK_IMPORTED_MODULE_32__["SubComponent"],
                _components_temp_temp_component__WEBPACK_IMPORTED_MODULE_33__["TempComponent"],
                _components_corvee_corvee_component__WEBPACK_IMPORTED_MODULE_34__["CorveeComponent"],
                _components_cwrite_cwrite_component__WEBPACK_IMPORTED_MODULE_35__["CwriteComponent"],
                _components_play_play_component__WEBPACK_IMPORTED_MODULE_36__["PlayComponent"]
            ],
            imports: [
...
var GameComponent = /** @class */ (function () {
    ...
    GameComponent.prototype.scrap = function () {
        var s = '<iframe src="' + this.funcService.ServerAddress + '/#/play/' + this.num + '" style="width: 560px; height: 480px;"></iframe>';
...
var PlayService = /** @class */ (function () {
    function PlayService(http, funcService) {
        this.http = http;
        this.funcService = funcService;
    }
